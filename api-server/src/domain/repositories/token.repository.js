import { DatabaseError, FcmTokenError } from '../../errors/CustomError.js';
...
export class TokenRepository {
    ...
    async upsertToken(userId, tokenValue) {
        try {
            ...
            console.error("TokenRepository upsertToken 에러:", error);
            throw new DatabaseError("토큰 정보를 저장할 수 없습니다.");
        }
    }
    ...
    async deleteToken(userId, tokenValue) {
        try {
            ...
            console.error("TokenRepository deleteToken 에러:", error);
            throw new DatabaseError("토큰을 삭제할 수 없습니다.");
        }
    }
    ...
    async findByUserId(userId) {
        try {
            ...
            throw new DatabaseError("사용자의 토큰 정보를 조회할 수 없습니다.");
        }
    }
    ...
    async findUserIdByToken(tokenValue) {
        try {
            ...
            throw new FcmTokenError("토큰으로 사용자를 조회할 수 없습니다.");
        }
    }
